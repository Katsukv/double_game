...
std::string path_to_path_to_background = "..//sprites//Doodle Jump//bck@2x.png";
std::string path_to_path_to_menu_background = "..//sprites//Doodle Jump//Default@2x.png";
